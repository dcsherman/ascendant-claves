...
$sOldPcFilePath 	= 'C:\Users\csherman\desktop\projects\AD_cleanup\old_computer_accounts.txt';
$sOnlinePcFilePath 	= 'C:\Users\csherman\desktop\projects\AD_cleanup\nline_pcs.txt';
